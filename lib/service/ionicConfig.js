...
let ionicConfig = function() {
  ...
  function addConfig(configObj, platformObj) {
    for (var n in configObj) {
      if (n != PLATFORM && configObj.hasOwnProperty(n)) {
        if (meteoric.angular.isObject(configObj[n])) {
  ...
  function createConfig(configObj, providerObj, platformPath) {
    meteoric.angular.forEach(configObj, function(value, namespace) {

      if (meteoric.angular.isObject(configObj[namespace])) {
...
meteoric.service.ionicConfig = new ionicConfig();