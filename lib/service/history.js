  ...
  return {
    ...
    register: function(parentScope, viewLocals) {
      ...
      if (forcedNav) {
        ...
        // Note: We don't create an element from the viewLocals template
        ...
        // add the new view
        console.log(this.currentStateName(), currentStateId, getCurrentStateParams());
