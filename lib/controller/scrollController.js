...
function($scope, scrollViewOptions) {
  ...
  $ionicScrollDelegate.addAggregate(this);
  ...
  $scope.$on('$destroy', function() {
    $ionicScrollDelegate.removeAggregate(this);
  ...
  self.anchorScroll = function(shouldAnimate) {
    self.resize().then(function() {
      ...
      var hash = /*$location.hash()*/ null;  // todo: deal with this when $location was created.
