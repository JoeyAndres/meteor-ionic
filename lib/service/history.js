...
let ionicHistory =
function() {
  let $rootScope = meteoric.Utils.$rootScope(),  // TODO: make a utility function that acquires the root scope.
      $state,  // TODO: https://github.com/angular-ui/ui-router, this is the router.
      $location,  // TODO: router or window.location or convert $location in angular-scenario
      $window = _.extend($(window), window),
